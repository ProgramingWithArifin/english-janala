...
const displayWordDetails = (detail) => {
    ...
    <div class="">
            <h2 class="text-2xl font-bold">${detail.word
        } (<i class="fa-solid fa-microphone-lines-slash"></i> ${detail.pronunciation
        })</h2>
          </div>
          <div class="">
    ...
    words.forEach((word) => {
        ...
        <div class="bg-white rounded-xl shadow-sm text-center py-10 px-5 space-y-4">
            ...
            <div class="flex justify-between items-center">
                ...
                <button onclick="pronounceWord('${word.word}')" class="hover:bg-blue-200 rounded p-2"><i class="fa-solid fa-volume-high"></i></button>
            </div>
        </div>
        `;
